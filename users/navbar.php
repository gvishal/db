    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation"><a href="index.php">DB PROJECT</a></li>
<?php
    if(array_key_exists("logged_in", $_SESSION)) {
        echo '<li role="presentation" class="active"><a href="#" >Welcome ' .$_SESSION["user"] . '!</a></li>';
        if (array_key_exists("admin", $_SESSION)) {
            if ($_SESSION["admin"]) {
                echo '<li role="presentation"><a href="index.php">User Crud</a></li>';
            }
        }
